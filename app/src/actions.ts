...
import type { Action, Filter, TaskId, TaskPriority } from "./types.js";
...
export function setTaskPriority(id: TaskId, priority: TaskPriority): Action {
  return { type: "task/prioritySet", payload: { id, priority } };
}
