...
export interface Task {
  ...
  /**
   * Optional so newly added tasks (which omit it) stay shape-compatible with
   * existing data and tests; absence means the default "normal" — read it
   * through the `taskPriority` selector rather than accessing this directly.
   */
  priority?: Priority;
}
